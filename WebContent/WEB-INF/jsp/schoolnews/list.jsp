...
<body ontouchstart>
	...
	<div class="">
		...
		<div class="weui_cells weui_cells_access weui_panel weui_panel_access" id="news_list">
			...
			<a class="weui_panel_ft" id="more_news_list" start="5" max="5" smallid="${smallid}">加载更多</a>
		</div>
