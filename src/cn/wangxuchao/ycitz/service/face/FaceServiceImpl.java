package cn.wangxuchao.ycitz.service.face;
...
public class FaceServiceImpl implements FaceService {
	private static final Log logger = LogFactory.getLog(FaceServiceImpl.class);
	...
	private static List<Face> faceDetect(String picUrl) {
		...
		try {
			...
			// 调用人脸检测接口
			String json = HttpClientUtil.httpGet(queryUrl);
			// 解析返回json中的Face列表
