...
import cn.wangxuchao.ycitz.dao.PizzaDAO;
import cn.wangxuchao.ycitz.model.Pizza;
import cn.wangxuchao.ycitz.model.User;
...
public class HelloController {
	...
	public String doActions(@ModelAttribute Pizza pizza, BindingResult result,
		...
		case "search":
			...
			pizzaResult = searchedStudent != null ? searchedStudent
					: new Pizza();
			break;
		}
